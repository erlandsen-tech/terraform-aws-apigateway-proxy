...
| <a name="input_ip_address_type"></a> [ip\_address\_type](#input\_ip\_address\_type) | IP address type for the API Gateway endpoint. Must be dualstack for PRIVATE endpoints. | `string` | `null` | no |
